...
import org.openxdata.mforms.midp.forms.location.NoGPSTypeEditorImpl;
 ...
 * 
 * @see org.openxdata.mforms.midp.forms.location.GPSTypeEditorImpl
 * 
	...
	public static GPSTypeEditor getGPSTypeEditor() {
		...
		if (isGPSAvailable()) {
	        try {
	            ...
	            Class c = Class.forName("org.openxdata.mforms.midp.forms.location.GPSTypeEditorImpl");
