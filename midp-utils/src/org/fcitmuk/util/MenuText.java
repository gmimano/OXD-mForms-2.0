...
public class MenuText {
    ...
    static {
        try {
            menuText.load(MenuText.class.getResourceAsStream("/menu_text.properties"));
        } catch (IOException e) {
            throw new RuntimeException("Could not find or load the translation file: " + e.getMessage());
        }
    }
